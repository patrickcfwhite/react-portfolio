...
const skills = ['javascript', 'python', 'html5', 'css3', 'react', 'nodejs', 'sass', 'django', 'github', 'npm', 'webpack', 'heroku', 'postgresql', 'mongodb', 'visualstudio']
      ...
      <div className="columns is-hidden-mobile">
        ...
        <div className="column is-two-fifths">
          ...
          <div className="columns is-multiline section skills">
            {skills.map(skill => {
              return (
                <div key={`${skill}-icon`} className="column is-3-desktop is-hidden-mobile">
